...
def text_to_track_drums(username, track_name, bpm, notes):
    ...
    drum_track.export(f"\\Cyber 12th grade\\Project\\tracks\\{username}-{track_name}.wav", format='wav')
...
def text_to_track_bass(username, track_name, bpm, notes):
    ...
    bass_track.export(f"\\Cyber 12th grade\\Project\\tracks\\{username}-{track_name}.wav", format='wav')
...
def text_to_track_guitar(username, track_name, bpm, notes):
    ...
    guitar_track.export(f"\\Cyber 12th grade\\Project\\tracks\\{username}-{track_name}.wav", format='wav')